...
<template>
  <el-sub-menu :index="index">
    ...
    <el-menu-item index="1-1" @click="loadProject()">{{ $t('file.load_project') }}</el-menu-item>
    ...
    <el-sub-menu index="1-9">
      ...
      <el-menu-item index="1-9-2" @click="exportNodes('lyp')">{{ $t('file.export_nodes.lychnis_format') }}</el-menu-item>
      <el-menu-item index="1-9-3" @click="exportNodes('swc')">{{ $t('file.export_nodes.swc_format') }}</el-menu-item>
